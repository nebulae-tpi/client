...
export const environment = {
  ...
  api: {
    gateway: {
      graphql: {
        httpEndPoint:
          'http://localhost:3000/api/client-gateway/graphql/http',
        wsEndPoint: 'ws://localhost:3000/api/client-gateway/graphql/ws',
        graphiqlEndPoint:
          'http://localhost:3000/api/client-gateway/graphiql'
      }
    }
  },
  google: {
